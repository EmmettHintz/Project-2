...
public abstract class Entity {
    ...
    public boolean isCollidingWith(Entity other){
        ...
        if (this.getX() >= other.getX() && this.getX() <= other.getRightX()){
            if (this.getBottomY() <= other.getBottomY() && this.getBottomY() >= other.getY()){
                return true;
            }
            if (other.getBottomY() <= this.getBottomY() && other.getBottomY() >= this.getY()){
                return true;
            }
        }

        if (other.getX() >= this.getX() && other.getX() <= this.getRightX()){
            if (this.getBottomY() <= other.getBottomY() && this.getBottomY() >= other.getY()){
                return true;
            }
            if (other.getBottomY() <= this.getBottomY() && other.getBottomY() >= this.getY()){
